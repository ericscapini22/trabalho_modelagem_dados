...
atualizarCompra.addEventListener('click', (e)=>{
    ...
    .then(resp => resp.json())
    .then(valores => {
        res.innerHTML = '<b>Compra atualizada com Sucesso!</b> <br><br><hr><br>'
        res.innerHTML += '<b>ID da Compra</b>: ' + valores.idCompra + '<br><br>'
        ...
        res.innerHTML += '<b>Status da Compra</b>: ' + valores.statusCompra
    })
    .catch((err)=>{
